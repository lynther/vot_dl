...
from ..utils import build_video_req, get_signature
from .data_class import TranslateResult
...
def translate_video(url: str, req_lang: str = "en", res_lang: str = "ru") -> TranslateResult:
    ...
    remaining_time = translate_res.remainingTime if translate_res.status == 2 else 0
